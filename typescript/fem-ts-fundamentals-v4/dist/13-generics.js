...
const foo = returnAs(43);
function makeTuple(arg1, arg2) {
    return [arg1, arg2];
}
const first = makeTuple(1, 2);
const second = makeTuple('foo', new Date());
console.log(first, second);
/*
 * always use generics more than just in function signature because type might get lost
 */
