...
let humid2 = 79 as const; //! humidity's type is { 79 } and treat it like a const, i know what i'm doing
...
function add(a: number, b: number): number { // adding return type of function can catch bugs earlier, establishes contract
